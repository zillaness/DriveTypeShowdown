...
;(function(){
  ...
  const WEAPONS=['spinner','buzzsaw','piston','flame','wedge'],ARMOR='balanced',N=20; // v5.1.108: the 5 PICKABLE weapons (RAM-ONLY/'none' dropped — it's the no-weapon baseline, not balanced against)
