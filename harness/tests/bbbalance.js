...
;(function(){
  ...
  const WEAPONS=['spinner','buzzsaw','piston','flame','wedge','flipper','pincer','kamikaze','drill','jet'],ARMOR='balanced',N=20; // the PICKABLE weapons (RAM-ONLY/'none' dropped — it's the no-weapon baseline, not balanced against); v5.1.175 + CANNON
