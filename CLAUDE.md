...
- Build: latest is `drive_showdown_v5.1.295.html` (single self-contained HTML). (Overnight 2026-06-24 haul 280→295 — see `HANDOFF_2026-06-20.md` Changelog v1.9: TASER, push-ball ∞-timed, career gamepad nav, respawn delay, parting-gift buff + draw-defer, give-up button, EXPERIMENTAL FEATURES gate, pincer escape, arena-edge hazards, STUN-MINE. New specs: `SPEC_2026-06-24_balloon_battle.md`, `SPEC_2026-06-24_combat_ideas.md`.)
