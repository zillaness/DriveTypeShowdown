...
- **`HANDOFF_2026-06-19.md`** — LATEST thread handoff (tip v5.1.249): map editor (done), Tournament v2 locked design + the agreed next build. **Start here when resuming.**
...
- Build: latest is `drive_showdown_v5.1.249.html` (single self-contained HTML).
