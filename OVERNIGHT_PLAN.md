...
1. `git fetch origin dev` and make sure you're on it. Current tip = **`drive_showdown_v5.1.160.html`** (v5.1.160).
...
- **State (cumulative, both threads): all green on `dev`, tip v5.1.160. P1 weapons · P2 perks · P4 minibots · P5 synergy · P6 eggs · **P7 cheats** · **P3 hazards+map-select** · **P9 modes (KO/sumo/domination/VIP) + CPU mode-awareness + objective HUD** · **Tournament T3 + T1-light** = DONE. NEW dev tool: `bbbalance2.js` (armor/perk/3v3-alliance report). OPEN: weapon balance re-tune; PIT STOP → pit-crew medic minibot rework.**
