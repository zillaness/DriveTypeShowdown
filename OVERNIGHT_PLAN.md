...
1. `git fetch origin dev` and make sure you're on it. Current tip = **`drive_showdown_v5.1.126.html`** (v5.1.126).
...
- **State: 29 commits this session (v5.1.99→126 + balance), all green on `dev`. P1 weapons · P2 perks · P4 minibots · P5 synergy · P6 eggs · **P7 cheats** · **P3 hazards+map-select** · **P9 modes (KO/sumo/domination/VIP) + CPU mode-awareness** · **balance re-verified** · **Tournament T3 (RoboRumble in bracket) + T1-light (alliance framing)** = DONE.**
